...
public class NTF1_WFO
{
    public static void ntf1_WFO() throws FileNotFoundException, IOException
    {
...
br=new BufferedReader(new FileReader(new File("C:/Users/phantom/Desktop/project/calculations/Weighted Frequency And Odds.txt")));
String content = new Scanner(new File("C:/Users/phantom/Desktop/project/calculations/Weighted Frequency And Odds.txt")).useDelimiter("\\Z").next();
...
for(int j=0;j<fileList.length;j++)
{
    ...
    while((s2=br1.readLine())!=null)
    {
       ...
       bw=new BufferedWriter(new FileWriter(new File("C:/Users/phantom/Desktop/project/calculations/variants/NTF2_WFO/" + fileList[j])));
   for(int m=0;m<l;m++)
    {
