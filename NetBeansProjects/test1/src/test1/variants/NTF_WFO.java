...
public class NTF_WFO
{
    public static void ntf_WFO() throws FileNotFoundException, IOException
    {
...
for(int j=0;j<fileList.length;j++)
{
    ...
    while((s2=br1.readLine())!=null)
    {
       ...
       bw=new BufferedWriter(new FileWriter(new File("C:/Users/phantom/Desktop/project/calculations/variants/NTF1_WFO/" + fileList[j])));
   for(int m=0;m<l;m++)
    {
