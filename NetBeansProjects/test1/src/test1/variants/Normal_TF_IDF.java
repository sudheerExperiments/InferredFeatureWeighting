...
for(int j=0;j<fileList.length;j++)
{
    ...
    while((s2=br1.readLine())!=null)
    {
       ...
       bw=new BufferedWriter(new FileWriter(new File("C:/Users/phantom/Desktop/project/calculations/variants/Normal1 TF_IDF/" + fileList[j])));
   for(int m=0;m<l;m++)
    {
