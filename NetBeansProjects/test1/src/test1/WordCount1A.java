...
public static void wordCount1() throws IOException
{
    ...
    bw=new BufferedWriter(new FileWriter(new File("C:/Users/phantom/Desktop/project/bucket of words count in all files2/all files bow countA.txt")));
