...
namespace LibSVMsharp.Examples.Classification
{
    class Program
    {
        ...
        {
            // Load the datasets
            SVMProblem trainingSet = SVMProblemHelper.Load(@"C:\Users\phantom\Desktop\project\calculations\variants\TF_WFO.txt");
            SVMProblem testSet = SVMProblemHelper.Load(@"C:\Users\phantom\Desktop\project\calculations\variants\TF_WFO.txt");
            ...
            // Save the model
            SVM.SaveModel(model, @"C:\Users\phantom\Desktop\project\calculations\variants\TF_WFO_model.txt");
            ...
            System.IO.StreamWriter file = new System.IO.StreamWriter(@"C:\Users\phantom\Desktop\project\calculations\performance values\performance values5.txt");
