...
public class SVMFormatConv6
{
    public static void svmFormatConv6() throws FileNotFoundException, IOException
    {
...
{
    arr1[i]=s.split(",");
    bowNum[i]=i+"";            //word in document in TF1_WFO(SVM file) is +1 of word in bucket of words
    i++;
}
...
for(int j=0;j<fileList.length;j++)
{
    ...
    l=0;
    br1=new BufferedReader(new FileReader(new File("C:/Users/phantom/Desktop/project/calculations/variants/NTF1_WFO/" + fileList[j])));
    String content1 = new Scanner(new File("C:/Users/phantom/Desktop/project/calculations/variants/NTF1_WFO/" + fileList[j])).useDelimiter("\\Z").next();
    ...
    f=new File("C:/Users/phantom/Desktop/project/calculations/variants/NTF_WFO.txt");
...
for(int j=0;j<fileList1.length;j++)
{
    Map<Integer, String> unsortMap = new HashMap<Integer, String>();
    l=0;
    br1=new BufferedReader(new FileReader(new File("C:/Users/phantom/Desktop/project/calculations/variants/NTF2_WFO/" + fileList1[j])));
    String content1 = new Scanner(new File("C:/Users/phantom/Desktop/project/calculations/variants/NTF2_WFO/" + fileList1[j])).useDelimiter("\\Z").next();
    arr2=new String[content1.length()][2];
    while((s2=br1.readLine())!=null)
    {
        arr2[l]=s2.split(",");
