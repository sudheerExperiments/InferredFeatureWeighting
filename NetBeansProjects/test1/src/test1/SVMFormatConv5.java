...
public class SVMFormatConv5
{
    public static void svmFormatConv5() throws FileNotFoundException, IOException
    {
...
for(int j=0;j<fileList.length;j++)
{
    ...
    l=0;
    br1=new BufferedReader(new FileReader(new File("C:/Users/phantom/Desktop/project/calculations/variants/TF1_WFO/" + fileList[j])));
    String content1 = new Scanner(new File("C:/Users/phantom/Desktop/project/calculations/variants/TF1_WFO/" + fileList[j])).useDelimiter("\\Z").next();
    ...
    f=new File("C:/Users/phantom/Desktop/project/calculations/variants/TF_WFO.txt");
...
for(int j=0;j<fileList1.length;j++)
{
    Map<Integer, String> unsortMap = new HashMap<Integer, String>();
    l=0;
    br1=new BufferedReader(new FileReader(new File("C:/Users/phantom/Desktop/project/calculations/variants/TF2_WFO/" + fileList1[j])));
    String content1 = new Scanner(new File("C:/Users/phantom/Desktop/project/calculations/variants/TF2_WFO/" + fileList1[j])).useDelimiter("\\Z").next();
    arr2=new String[content1.length()][2];
    while((s2=br1.readLine())!=null)
    {
        arr2[l]=s2.split(",");
